...
| <span id="quiz2">Quiz 2</span> | October 7th | [Review Set 2](/psets/R2.pdf) (<a onclick="alert(`To be released.`)">Solutions</a>) <br> (<a onclick="alert(`In perperation.`)">Review Slides</a>) | To be announced |
| Quiz 3 | October 28th |  |  |
